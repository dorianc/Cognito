    ...
    public partial class AppDelegate : FormsApplicationDelegate
    {
        ...
        void RegisterDependencies()
        {
			...
			if (Settings.IsUsingLocalDataSource)
                builder.RegisterInstance(_LazyFilesystemOnlyAcquaintanceDataSource.Value).As<IDataSource<Client>>();
            else
                builder.RegisterInstance(_LazyAzureAcquaintanceSource.Value).As<IDataSource<Client>>();
        ...
        {
            var dataSource = ServiceLocator.Current.GetInstance<IDataSource<Client>>();
