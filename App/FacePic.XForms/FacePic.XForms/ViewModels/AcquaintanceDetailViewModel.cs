...
namespace Acquaint.XForms
{
    ...
    {
		public AcquaintanceDetailViewModel(Client acquaintance)
		{
		...
		void ExecuteDeleteAcquaintanceCommand()
		{
			MessagingService.Current.SendMessage<MessagingServiceQuestion>(MessageKeys.DisplayQuestion, new MessagingServiceQuestion()
			{
				...
				OnCompleted = new Action<bool>(async result => {
					...
					MessagingService.Current.SendMessage<Client>(MessageKeys.DeleteAcquaintance, Acquaintance);
        ...
        void SubscribeToSaveAcquaintanceMessages()
        {
            ...
            MessagingService.Current.Subscribe<Client>(MessageKeys.UpdateAcquaintance, (service, acquaintance) =>
                {
					Acquaintance = acquaintance;
					OnPropertyChanged("Acquaintance");

                	MessagingService.Current.SendMessage<Client>(MessageKeys.AcquaintanceLocationUpdated, Acquaintance);
                });
        }
