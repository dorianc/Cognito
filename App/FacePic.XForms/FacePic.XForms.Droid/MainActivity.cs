...
namespace Acquaint.XForms.Droid
{
   ...
   //             builder.RegisterInstance(_LazyFilesystemOnlyAcquaintanceDataSource.Value).As<IDataSource>();
   //         else
                builder.RegisterInstance(_LazyAzureAcquaintanceSource.Value).As<IDataSource>();
        ...
        {
            var dataSource = ServiceLocator.Current.GetInstance<IDataSource>();
